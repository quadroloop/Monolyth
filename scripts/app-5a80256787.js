...
function () {
    ...
    function a(e, a) {
        var t = a.colors;
        e.setOptions({
            chartColors: [t.primary, t.danger, t.warning, t.success, t.info, t.
            default, t.primaryDark, t.successDark, t.warningLight, t.successLight, t.primaryLight],
            responsive: !0,
            ...
            link: function (a, t) {
                e(function () {
                    ...
                    var i = t.attr("new-value"),
                        s = parseInt(t.html());
                    if (i > s) for (var l = s; l <= i; l++) a(l);
                    else for (var o = s; o >= i; o--) a(o);
                    e(function () {
